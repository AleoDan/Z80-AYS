...
All HC computers have very stable 3.54 MHz clock output on the extension connector, so the sound inteface uses this clock divided by two and don't need another on-board oscillator.
